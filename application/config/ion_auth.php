...
*/
$config['tables']['users']           = 'data_users';
$config['tables']['groups']          = 'data_users_groups';
$config['tables']['users_groups']    = 'data_users_u_groups';
$config['tables']['login_attempts']  = 'data_users_login_attempts';
